...
require (
	...
	github.com/giantswarm/k8scloudconfig/v18 v18.0.0
...
replace (
	...
	github.com/getsentry/sentry-go => github.com/getsentry/sentry-go v0.27.0
	...
	github.com/opencontainers/runc => github.com/opencontainers/runc v1.1.11
