...
func New(config Config) (*Service, error) {
	...
	var clusterapiClusterController *clusterapi.Cluster
	{
		...
		c := clusterapi.ClusterConfig{
			...
			CalicoCIDR:            config.Viper.GetString(config.Flag.Service.Cluster.Calico.CIDR),
			CalicoMTU:             config.Viper.GetString(config.Flag.Service.Cluster.Calico.MTU),
			...
			DockerDaemonCIDR:      config.Viper.GetString(config.Flag.Service.Cluster.Kubernetes.Docker.Daemon.CIDR),
