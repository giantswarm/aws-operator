	...
	s.bootOnce.Do(func() {
		...
		_, clusterInformer := cache.NewInformer(
			...
			cache.ResourceEventHandlerFuncs{
				AddFunc:    s.handleAddCluster,
				DeleteFunc: s.handleDeleteCluster,
			},
		)
...
func (s *Service) handleAddCluster(obj interface{}) {
...
func (s *Service) handleDeleteCluster(obj interface{}) {
