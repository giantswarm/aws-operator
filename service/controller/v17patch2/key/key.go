...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v17patch2/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/v17patch2/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/v17patch2/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/v17patch2/templates/cloudformation/hostpre"
)

const (
	// CloudConfigVersion defines the version of k8scloudconfig in use.
	// It is used in the main stack output and S3 object paths.
	CloudConfigVersion = "v_3_6_4"
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v17patch2/key/key_test.go
		service/controller/v17patch2/adapter/adapter_test.go
		service/controller/v17patch2/resource/cloudformation/main_stack_test.go
