...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/cluster/resource/tccp/template"
	"github.com/giantswarm/aws-operator/service/controller/cluster/unittest"
)
...
//
//  go test ./service/controller/cluster/resource/tccp -run Test_Controller_Resource_TCCP_Template_Render -update
//
