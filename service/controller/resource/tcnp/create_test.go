...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/cluster/resource/tcnp/template"
...
//
//  go test ./service/controller/cluster/resource/tcnp -run Test_Controller_Resource_TCNP_Template_Render -update
//
