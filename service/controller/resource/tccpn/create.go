...
func (r *Resource) newAutoScalingGroup(ctx context.Context, cr infrastructurev1alpha3.AWSControlPlane, isNewASG bool) (*template.ParamsMainAutoScalingGroup, error) {
	cc, err := controllercontext.FromContext(ctx)
	if err != nil {
		return nil, microerror.Mask(err)
	}
...
func (r *Resource) newTemplateParams(ctx context.Context, cr infrastructurev1alpha3.AWSControlPlane, isNew bool) (*template.ParamsMain, error) {
	var params *template.ParamsMain
	{
		autoScalingGroup, err := r.newAutoScalingGroup(ctx, cr, isNew)
		if err != nil {
			return nil, microerror.Mask(err)
		}
