...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/cluster/resource/tcnpf/template"
...
//
//  go test ./service/controller/cluster/resource/tcnpf -run Test_Controller_Resource_TCNPF_Template_Render -update
//
