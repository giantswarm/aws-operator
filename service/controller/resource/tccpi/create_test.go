...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/cluster/resource/tccpi/template"
...
//
//  go test ./service/controller/cluster/resource/tccpi -run Test_Controller_Resource_TCCPI_Template_Render -update
//
