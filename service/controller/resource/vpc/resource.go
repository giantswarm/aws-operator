...
func (r *Resource) addVPCInfoToContext(ctx context.Context, cr v1alpha1.AWSConfig) error {
	...
	{
		cidr, vpcID, err := r.lookup(ctx, cc.Client.ControlPlane.AWS.EC2, r.installationName)
		if err != nil {
			return microerror.Mask(err)
		}
