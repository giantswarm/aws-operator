...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/cluster/resource/tccpf/template"
...
//
//  go test ./service/controller/cluster/resource/tccpf -run Test_Controller_Resource_TCCPF_Template_Render -update
//
