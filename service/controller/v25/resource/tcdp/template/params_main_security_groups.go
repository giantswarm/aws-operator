...
func (s *ParamsMainSecurityGroups) Adapt(cfg Config) error {
...
func (s *ParamsMainSecurityGroups) getMasterRules(cfg Config, hostClusterCIDR string) ([]securityGroupRule, error) {
...
func (s *ParamsMainSecurityGroups) getWorkerRules(customObject v1alpha1.AWSConfig, hostClusterCIDR string) []securityGroupRule {
...
func (s *ParamsMainSecurityGroups) getIngressRules(customObject v1alpha1.AWSConfig) []securityGroupRule {
	return []securityGroupRule{
		{
...
func (s *ParamsMainSecurityGroups) getEtcdRules(customObject v1alpha1.AWSConfig, hostClusterCIDR string) []securityGroupRule {
	return []securityGroupRule{
		{
