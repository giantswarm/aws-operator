...
/usr/bin/rkt run \
    ...
    docker://registry-intl.cn-shanghai.aliyuncs.com/giantswarm/awscli:latest -- aws s3 --region {{.Region}} cp s3://{{.S3URI}}/cloudconfig/{{.CloudConfigVersion}}/$USERDATA_FILE /var/run/coreos/temp.txt
