...
/usr/bin/rkt run \
    ...
    306934455918.dkr.ecr.cn-north-1.amazonaws.com.cn/awscli:latest -- aws s3 --region {{.Region}} cp s3://{{.S3URI}}/cloudconfig/{{.CloudConfigVersion}}/$USERDATA_FILE /var/run/coreos/temp.txt
