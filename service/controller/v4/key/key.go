...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v4/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/v4/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/v4/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/v4/templates/cloudformation/hostpre"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/awsconfig/v4/key/key_test.go
		service/awsconfig/v4/resource/cloudformation/adapter/adapter_test.go
