...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v9_patch1/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/v9_patch1/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/v9_patch1/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/v9_patch1/templates/cloudformation/hostpre"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/awsconfig/v9_patch1/key/key_test.go
		service/awsconfig/v9_patch1/resource/cloudformation/adapter/adapter_test.go
