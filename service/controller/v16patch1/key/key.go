...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v16patch1/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/v16patch1/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/v16patch1/templates/cloudformation/hostpre"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v16patch1/key/key_test.go
		service/controller/v16patch1/adapter/adapter_test.go
		service/controller/v16patch1/resource/cloudformation/main_stack_test.go
