...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v15/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/v15/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/v15/templates/cloudformation/hostpre"
)

const (
	// CloudConfigVersion defines the version of k8scloudconfig in use.
	// It is used in the main stack output and S3 object paths.
	CloudConfigVersion = "v_3_5_0"
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v15/key/key_test.go
		service/controller/v15/adapter/adapter_test.go
		service/controller/v15/resource/cloudformation/main_stack_test.go
