...
func (c *Collector) Collect(ctx context.Context) ([]net.IPNet, error) {
	var err error
...
func (c *Collector) getSubnetsFromAWSConfigs(ctx context.Context) ([]net.IPNet, error) {
...
func (c *Collector) getSubnetsFromClusters(ctx context.Context) ([]net.IPNet, error) {
...
func (c *Collector) getSubnetsFromMachineDeployments(ctx context.Context) ([]net.IPNet, error) {
...
func (c *Collector) getSubnetsFromVPCs(ctx context.Context) ([]net.IPNet, error) {
