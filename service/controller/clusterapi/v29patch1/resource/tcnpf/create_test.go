...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/clusterapi/v29patch1/resource/tcnpf/template"
...
//
//  go test ./service/controller/clusterapi/v29patch1/resource/tcnpf -run Test_Controller_Resource_TCNPF_Template_Render -update
//
