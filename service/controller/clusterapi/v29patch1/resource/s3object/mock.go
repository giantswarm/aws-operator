...
func (c *CloudConfigMock) NewMasterTemplate(ctx context.Context, customObject v1alpha1.Cluster, clusterCerts certs.Cluster, randomKeys randomkeys.Cluster) (string, error) {
	return c.template, nil
}

func (c *CloudConfigMock) NewWorkerTemplate(ctx context.Context, customObject v1alpha1.Cluster, clusterCerts certs.Cluster) (string, error) {
	return c.template, nil
}
