...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/clusterapi/v30/resource/tccpi/template"
...
//
//  go test ./service/controller/clusterapi/v30/resource/tccpi -run Test_Controller_Resource_TCCPI_Template_Render -update
//
