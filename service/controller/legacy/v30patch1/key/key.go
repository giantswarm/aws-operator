...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v30patch1/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v30patch1/templates/cloudformation/tccp"
)

const (
	// CloudConfigVersion defines the version of k8scloudconfig in use.
	// It is used in the main stack output and S3 object paths.
	CloudConfigVersion = "v_4_8_1"
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v30patch1/key/key_test.go
		service/controller/v30patch1/adapter/adapter_test.go
		service/controller/v30patch1/resource/cloudformation/main_stack_test.go
