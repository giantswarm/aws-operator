...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/cloudformation"
...
func (r *Resource) EnsureCreated(ctx context.Context, obj interface{}) error {
...

	{
		...
		if cloudformation.IsOutputNotFound(err) {
			...
			// v25. The code can be cleaned up in v28patch1 and the controller context value
