...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/controllercontext"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/credential"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/detection"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/encrypter"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/encrypter/kms"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/encrypter/vault"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/key"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/accountid"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/asgstatus"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/bridgezone"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/cleanupsecuritygroups"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/cpf"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/cpi"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/ebsvolume"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/encryption"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/endpoints"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/ipam"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/loadbalancer"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/migration"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/namespace"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/natgatewayaddresses"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/peerrolearn"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/routetable"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/s3bucket"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/s3object"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/secretfinalizer"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/service"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/tccp"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/tccpoutputs"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/tccpsubnet"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v28patch1/resource/vpccidr"
