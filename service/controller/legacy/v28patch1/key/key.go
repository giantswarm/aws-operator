...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/legacy/v28patch1/key/key_test.go
		service/controller/legacy/v28patch1/adapter/adapter_test.go
		service/controller/legacy/v28patch1/resource/cloudformation/main_stack_test.go
