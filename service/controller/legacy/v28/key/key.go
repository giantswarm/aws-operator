...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v27/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v27/templates/cloudformation/tccp"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v28/key/key_test.go
		service/controller/v28/adapter/adapter_test.go
		service/controller/v28/resource/cloudformation/main_stack_test.go
