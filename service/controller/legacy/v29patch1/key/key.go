...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v29patch1/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v29patch1/templates/cloudformation/tccp"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v29patch1/key/key_test.go
		service/controller/v29patch1/adapter/adapter_test.go
		service/controller/v29patch1/resource/cloudformation/main_stack_test.go
