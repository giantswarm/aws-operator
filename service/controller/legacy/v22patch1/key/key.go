...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v22patch1/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v22patch1/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v22patch1/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v22patch1/templates/cloudformation/hostpre"
)

const (
	// CloudConfigVersion defines the version of k8scloudconfig in use.
	// It is used in the main stack output and S3 object paths.
	CloudConfigVersion = "v_4_0_1"
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v22patch1/key/key_test.go
		service/controller/v22patch1/adapter/adapter_test.go
		service/controller/v22patch1/resource/cloudformation/main_stack_test.go
