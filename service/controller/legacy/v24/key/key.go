...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v24/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v24/templates/cloudformation/tccp"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v24/key/key_test.go
