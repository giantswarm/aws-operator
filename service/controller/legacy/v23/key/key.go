...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/legacy/v23/templates/cloudconfig"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v23/templates/cloudformation/guest"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v23/templates/cloudformation/hostpost"
	"github.com/giantswarm/aws-operator/service/controller/legacy/v23/templates/cloudformation/hostpre"
)
...
func ImageID(customObject v1alpha1.AWSConfig) (string, error) {
	...
	/*
		...
		service/controller/v23/key/key_test.go
		service/controller/v23/adapter/adapter_test.go
		service/controller/v23/resource/cloudformation/main_stack_test.go
