...
import (
	...
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/cloudconfig"
	cloudformationservice "github.com/giantswarm/aws-operator/service/controller/v14patch1/cloudformation"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/controllercontext"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/credential"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/ebs"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/encrypter"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/encrypter/kms"
	...
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/bridgezone"
	cloudformationresource "github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/cloudformation"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/ebsvolume"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/encryptionkey"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/endpoints"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/hostedzone"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/loadbalancer"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/migration"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/namespace"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/s3bucket"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/s3object"
	"github.com/giantswarm/aws-operator/service/controller/v14patch1/resource/service"
)
