...
/usr/bin/rkt run \
    ...
    quay.io/coreos/awscli:025a357f05242fdad6a81e8a6b520098aa65a600 -- aws s3 --region {{.Region}} cp s3://{{.S3Bucket}}/{{.ClusterID}}/cloudconfig/$USERDATA_FILE /var/run/coreos/temp.txt
