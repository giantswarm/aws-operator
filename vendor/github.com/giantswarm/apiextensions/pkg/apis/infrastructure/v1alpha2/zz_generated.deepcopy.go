...
func (in *AWSMachineDeploymentSpecProvider) DeepCopyInto(out *AWSMachineDeploymentSpecProvider) {
	*out = *in
	...
	out.SpotInstanceConfiguration = in.SpotInstanceConfiguration
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSMachineDeploymentSpecSpotInstanceConfiguration) DeepCopyInto(out *AWSMachineDeploymentSpecSpotInstanceConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSMachineDeploymentSpecSpotInstanceConfiguration.
func (in *AWSMachineDeploymentSpecSpotInstanceConfiguration) DeepCopy() *AWSMachineDeploymentSpecSpotInstanceConfiguration {
	if in == nil {
		return nil
	}
	out := new(AWSMachineDeploymentSpecSpotInstanceConfiguration)
	in.DeepCopyInto(out)
	return out
}
